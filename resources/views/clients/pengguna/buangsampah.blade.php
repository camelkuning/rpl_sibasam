                        ...
                        <form method="POST" action="{{ route('pengguna.postBuangSampah') }}" autocomplete="on">
                            ...
                            <div class="mb-3 " id="username">
                                ...
                                <input name="BeratSampah" type="text"
                                    class=" border border-dark form-control @error('BeratSampah') is-invalid @enderror" placeholder="Masukan Berat Sampah Anda" required>
                            </div>

                            <div class="mb-3" id="JenisSampah">
                                <label for="JenisSampah">Jenis Sampah</label>
                                <select class="border border-dark form-select" name="JenisSampah" id="JenisSampah">
                            ...
                            <div class="mb-3 " id="lokasi">
                                ...
                                <select class="border border-dark form-select" name="lokasi" id="lokasi">
